...
public class ServiceResource {
	...
	@PostMapping()
	public ResponseEntity<Void> insert(@RequestBody BarberShopService obj) {
	...
	@PutMapping(value="/{id}")
	public ResponseEntity<Void> update(@RequestBody BarberShopService obj, @PathVariable Integer id) {
		obj.setId(id);
